(function () {
  "use strict";
  /*! js-cookie v3.0.5 | MIT */ function B(e) {
...
`,
    ...
    N = ({ referrerURL: e, referrerHost: o }) => {
      g.events.onLocationChange({ referrerURL: e, referrerHost: o });
    },
    ie = () => {
  ...
  const ge = (e) => {
    ...
    pe = (e) => {
      (g.events.onBubbleToggle(e),
        e ? E({ eventName: de }) : (E({ eventName: ce }), U.focus()));
    },
    S = (e = {}) => {
    ...
    var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
      o = {
        ...
        bytesToWords: function (t) {
          for (var c = [], r = 0, n = 0; r < t.length; r++, n += 8)
            c[n >>> 5] |= t[r] << (24 - (n % 32));
          return c;
        },
        ...
        bytesToBase64: function (t) {
          for (var c = [], r = 0; r < t.length; r += 3)
            for (
              var n = (t[r] << 16) | (t[r + 1] << 8) | t[r + 2], u = 0;
              u < 4;
              u++
            )
              r * 8 + u * 6 <= t.length * 8
                ? c.push(e.charAt((n >>> (6 * (3 - u))) & 63))
                : c.push("=");
          return c.join("");
        },
        base64ToBytes: function (t) {
          ...
          for (var c = [], r = 0, n = 0; r < t.length; n = ++r % 4)
            n != 0 &&
              c.push(
                ((e.indexOf(t.charAt(r - 1)) & (Math.pow(2, -2 * n + 8) - 1)) <<
                  (n * 2)) |
                  (e.indexOf(t.charAt(r)) >>> (6 - n * 2)),
              );
          return c;
        },
      };
    ...
    var e = Ce,
      ...
      r = function (n, u) {
        ...
        for (
          ...
          i[w] =
            (((i[w] << 8) | (i[w] >>> 24)) & 16711935) |
            (((i[w] << 24) | (i[w] >>> 8)) & 4278255360);
        ((i[b >>> 5] |= 128 << (b % 32)),
          (i[(((b + 64) >>> 9) << 4) + 14] = b));
        for (
          var h = r._ff, p = r._gg, f = r._hh, m = r._ii, w = 0;
          w < i.length;
          w += 16
        ) {
          var Pe = s,
  ...
  const _e = ye(Be),
    ...
    Ae = async (e = "", o) => {
      ...
      if (t) {
        ...
        fetch(i)
          ...
          .then((b) => (t.decodeAudioData(b).then(c), new Promise((s) => s())))
          .catch(() => {});
      }
    },
    Ue = ({ origin: e, conversationCookie: o, websiteToken: t, locale: c }) => {
      ...
      return (
        r.searchParams.append("cw_conversation", o),
  ...
  function Le(e) {
    ...
    return e instanceof Date || (typeof e == "object" && o === "[object Date]")
      ? new Date(e.getTime())
      : typeof e == "number" || o === "[object Number]"
        ? new Date(e)
        : ((typeof e == "string" || o === "[object String]") &&
            typeof console < "u" &&
            (console.warn(
  ...
  const ee = (e, o = "") => O("cw_conversation", e, { baseDomain: o }),
    Re = (e) => {
      const o = Ne(new Date(), 1);
      O("cw_snooze_campaigns_till", Number(o), { expires: o, baseDomain: e });
    },
    g = {
      ...
      createFrame: ({ baseUrl: e, websiteToken: o }) => {
        ...
        let r = g.getUrl({ baseUrl: e, websiteToken: o });
      ...
      getBubbleHolder: () =>
        document.getElementsByClassName("woot--bubble-holder"),
      sendMessage: (e, o) => {
        g.getAppFrame().contentWindow.postMessage(
          `chatwoot-widget:${JSON.stringify({ event: e, ...o })}`,
          "*",
        );
      },
      ...
      setupAudioListeners: () => {
        ...
        Ae(e, { type: "widget", alertTone: "ding" }).then(() =>
          Z.forEach((o) => {
      ...
      events: {
        loaded: (e) => {
          ...
          (g.sendMessage("config-set", {
            ...
            g.onLoad({ widgetColor: e.config.channelConfig.widgetColor }),
            g.toggleCloseButton(),
            window.$chatwoot.user &&
              g.sendMessage("set-user", window.$chatwoot.user),
            (window.playAudioAlert = () => {}),
            Z.forEach((t) => {
              document.addEventListener(t, g.setupAudioListeners, !1);
            }),
            window.$chatwoot.resetTriggered || E({ eventName: le }));
        },
        error: ({ errorType: e, data: o }) => {
          (E({ eventName: ae, data: o }), e === xe && x.remove(L()));
        },
        ...
        postback(e) {
          E({ eventName: se, data: e });
        },
        toggleBubble: (e) => {
          let o = {};
          (e === "open"
            ? (o.toggleValue = !0)
            : e === "close" && (o.toggleValue = !1),
            S(o));
        },
        ...
        onBubbleToggle: (e) => {
          (g.sendMessage("toggle-open", { isOpen: e }),
            e && g.pushEvent("webwidget.triggered"));
        },
        onLocationChange: ({ referrerURL: e, referrerHost: o }) => {
          g.sendMessage("change-url", { referrerURL: e, referrerHost: o });
        },
        ...
        handleNotificationDot: (e) => {
          ...
          !o.classList.contains("unread-notification")
            ? y(o, "unread-notification")
            : e.unreadMessageCount === 0 && _(o, "unread-notification");
        },
        closeChat: () => {
          S({ toggleValue: !1 });
        },
      ...
      pushEvent: (e) => {
        g.sendMessage("push-event", { eventName: e });
      },
      onLoad: ({ widgetColor: e }) => {
        ...
        (z(window.$chatwoot.widgetStyle) &&
          ((t += " woot-widget-bubble--flat"),
          (c += " woot-widget-bubble--flat")),
          ve(e) &&
            ((t += " woot-widget-bubble-color--lighter"),
            (c += " woot-widget-bubble-color--lighter")));
        const r = be({ className: t, path: ue, target: U });
        (y($, c),
      ...
      toggleCloseButton: () => {
        ...
        (window.matchMedia("(max-width: 668px)").matches && (e = !0),
          g.sendMessage("toggle-close-button", { isMobile: e }));
      },
    },
    ...
    We = ({ baseUrl: e, websiteToken: o }) => {
      ...
      (document.addEventListener("turbo:before-render", (n) => {
        ...
        window.Turbolinks &&
          document.addEventListener("turbolinks:before-render", (n) => {
            F(n.data.newBody);
          }),
        document.addEventListener("astro:before-swap", (n) =>
          F(n.newDocument.body),
        ));
      const t = window.chatwootSettings || {};
      let c = t.locale,
        r = t.baseDomain;
      (t.useBrowserLanguage &&
        ...
        (window.$chatwoot = {
          ...
          toggleBubbleVisibility(n) {
            ...
            (n === "hide"
              ? (y(i, "woot-widget--without-bubble"),
                y(u, "woot-hidden"),
          ...
          setUser(n, u) {
            ...
            const i = L(),
              b = x.get(i),
              s = Me({ identifier: n, user: u });
            s !== b &&
              ((window.$chatwoot.identifier = n),
              (window.$chatwoot.user = u),
              g.sendMessage("set-user", { identifier: n, user: u }),
              O(i, s, { baseDomain: r }));
          },
          setCustomAttributes(n = {}) {
            if (!n || !Object.keys(n).length)
              throw new Error("Custom attributes should have atleast one key");
            g.sendMessage("set-custom-attributes", { customAttributes: n });
          },
          deleteCustomAttribute(n = "") {
            if (n)
              g.sendMessage("delete-custom-attribute", { customAttribute: n });
          ...
          setLabel(n = "") {
            g.sendMessage("set-label", { label: n });
          },
          removeLabel(n = "") {
            g.sendMessage("remove-label", { label: n });
          },
          setLocale(n = "en") {
            g.sendMessage("set-locale", { locale: n });
          },
          setColorScheme(n = "light") {
            g.sendMessage("set-color-scheme", { darkMode: j(n) });
          },
          reset() {
        ...
        g.createFrame({ baseUrl: e, websiteToken: o }));
    };
  window.chatwootSDK = { run: We };
})();
